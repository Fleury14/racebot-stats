import { DATA_START_LOADING, DATA_DONE_LOADING, BOT_DATA_ERROR, DATA_DONE_LOADING_RACER, DATA_DONE_LOADING_SINGLE_RACE, DATA_DONE_LOADING_ALL_RACERS, DATA_DONE_LOADING_FEATURED_RACERS, DATA_DONE_LOADING_EVENTS, RESET_BOT_DATA } from '../actions/types';

const INITIAL_STATE = { data: null, loading: false, error: null, racerData: null, singleRaceData: null, allRacerData: null, featuredRacers: null, events: null };
...
export default (state = INITIAL_STATE, action) => {
  switch (action.type) {
    ...
    case DATA_DONE_LOADING_EVENTS:
      return { ...state, loading: false, error: null, events: action.payload.data};
    case RESET_BOT_DATA:
