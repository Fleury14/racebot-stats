...
class RacerStats extends Component {
  ...
  componentDidMount() {
    ...
    if (!this.props.generalData || !this.state.generalData) {
      ...
      this.setState({ generalData: this.props.generalData, twov2Data: parse2v2Data(this.props.generalData.items || this.props.generalData) });
    }
  ...
  componentDidUpdate(prevProps, prevState) {
    if ((!this.state.racerData && prevProps.racerData && prevProps.racerData.name) || (prevProps.racerData && prevProps.racerData.name !== this.state.racerData.name)) {
